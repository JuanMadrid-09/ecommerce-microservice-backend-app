...
*/
        ...
        stage('Deploy Core Services') {
            ...
            steps {
                ...
                bat "kubectl rollout status deployment/service-discovery -n ${K8S_NAMESPACE} --timeout=220s"
                ...
                bat "kubectl rollout status deployment/cloud-config -n ${K8S_NAMESPACE} --timeout=250"
            }
        }
